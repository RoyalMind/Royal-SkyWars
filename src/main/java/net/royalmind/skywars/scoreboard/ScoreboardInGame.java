...
public class ScoreboardInGame implements ScoreboardHandler {

    private RoyalSkyWars royalSkyWars;
    private final FileConfiguration config;
    private HighlightedString title;

    public ScoreboardInGame(final RoyalSkyWars royalSkyWars) {
    ...
    public List<Entry> getEntries(Player player) {
        ...
        for (String s : getConfig().getStringList("Scoreboard.InGame.Body")) {
